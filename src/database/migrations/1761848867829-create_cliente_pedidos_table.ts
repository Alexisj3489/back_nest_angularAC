...
export class CreateClientePedidosTable1761848867829 implements MigrationInterface {
    name = 'CreateClientePedidosTable1761848867829'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "roles" RENAME COLUMN "descripcion" TO "detalle"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "roles" RENAME COLUMN "detalle" TO "descripcion"`);
    }
